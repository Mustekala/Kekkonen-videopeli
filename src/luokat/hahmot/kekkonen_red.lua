...
function kekkonen_red:lataaAnimaatiot()
	...
	self.heitto_anim = newAnimation(kuvat["kekkonen_heitto_red.png"],40,61,0.05,10)
	self.heitto_anim:setMode("once")

	self.paikallaan_anim = newAnimation(kuvat["kekkonen_paikallaan_red.png"],35,61,0.5,2)
	...
	self.laskeutuminen_anim = newAnimation(kuvat["kekkonen_laskeutuminen_red.png"],33,62,0.05,6)
